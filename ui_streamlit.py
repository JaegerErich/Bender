...
<style>
    ...
    /* Day missed: no red — grey box via ::before (number+date only), "Missed day" below box */
    ...
    div:has(#plan-day-grid) ~ div [data-testid="stHorizontalBlock"] > *:has(.plan-day-missed)::before {
        ...
        width: 100% !important; height: 3.2rem !important; background: #4a4a4a !important;
    ...
    /* Missed day: text below grey box (margin creates gap between box and text) */
